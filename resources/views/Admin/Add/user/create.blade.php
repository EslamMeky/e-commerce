                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('store_user')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> Data User </h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="projectinput1">Name User </label>
                                                            ...
                                                            <div class="col-md-6 ">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> Email User </label>
                                                ...
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> Password User </label>
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    <label for="projectinput1"> Confirm Password User </label>
                                                    <input type="password"  id="name"
                                                           class="form-control"
