                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('create_admin')}}"> Update Sub Category </a>
                                </li>
                                <li class="breadcrumb-item active">Update Sub Category
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> Update Sub Category </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('update.subCategory',$subcategory->id)}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> Data Sub Category </h4>


                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Name Sub Category in Arabic </label>
                                                            <input type="text" value="{{$subcategory->name_ar}}" id="name"
                                                                   class="form-control"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$subcategory->price}}" id="name"
                                                                   class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$subcategory->description_ar}}" id="name"
                                                                   class="form-control"
