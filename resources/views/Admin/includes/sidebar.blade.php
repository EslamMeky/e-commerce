    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item active"><a href="{{route('dashboard')}}"><i class="la la-mouse-pointer"></i><span
                        class="menu-title" data-i18n="nav.add_on_drag_drop.main">Main Bar </span></a>
            </li>


            <li class="nav-item"><a href=""><i class=""></i>
                    <span class="menu-title" data-i18n="nav.dash.main">Main Category </span>
                    <span class="badge badge badge-danger badge-pill float-right mr-2"></span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('show.category')}}"
                                          data-i18n="nav.dash.ecommerce">Show Main Category</a>
                    </li>
                    <li><a class="menu-item" href="{{route('create.category')}}" data-i18n="nav.dash.crypto">Add New Main Category</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class=""></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('show.subCategory')}}"
                                          data-i18n="nav.dash.ecommerce">Show Categories</a>
                    </li>
                    <li><a class="menu-item" href="{{route('create.subCategory')}}" data-i18n="nav.dash.crypto">Add New Category</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class=""></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('show.order')}}"
                                          data-i18n="nav.dash.ecommerce">Show Orders</a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class=""></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> Contact</span>
                    <span class="badge badge badge-danger badge-pill float-right mr-2"></span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('show.feedback')}}"
                                          data-i18n="nav.dash.ecommerce">Show FeedBacks</a>
                    </li>
                    <li class="active"><a class="menu-item" href="{{route('show.subscribe')}}"
                                          data-i18n="nav.dash.ecommerce">Show Subscribe</a>
                    </li>
            ...
            <li class="nav-item   ">
                <a href=""><i class="la la-navicon"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('create_admin')}}"
                                          data-i18n="nav.dash.ecommerce"> Add Admin </a>
                    </li>
                    <li><a class="menu-item" href="{{route('show_admin')}}" data-i18n="nav.dash.crypto"> Show Admin</a>
                    </li>
                    <li class="active"><a class="menu-item" href="{{route('create_user')}}"
                                          data-i18n="nav.dash.ecommerce"> Add User </a>
                    </li>
                    <li><a class="menu-item" href="{{route('show_user')}}" data-i18n="nav.dash.crypto"> Show User</a>
                    </li>
                </ul>
...
{{--                    </li>--}}
{{--                    <li><a class="menu-item" href="" data-i18n="nav.dash.crypto">Add New Vendor</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
